...
public class LinguagemGrupo2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linguagem_grupo2);
...
// *************************************************************
    ...
    private String naonulo(String entrada) {
     ...
     private void mensangemdeerro() {
        Toast.makeText(LinguagemGrupo2.this,"Valor da entrada incorreta",Toast.LENGTH_SHORT).show();
    }

    private void chamaNovoQuestionario() {
        startActivity(new Intent(LinguagemGrupo2.this, LinguagemGrupo3.class));
        finish();
    }
