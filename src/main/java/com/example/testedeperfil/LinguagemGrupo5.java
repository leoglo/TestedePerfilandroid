...
public class LinguagemGrupo5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linguagem_grupo5);
...
// *************************************************************
    ...
    private void mensangemdeerro() {
        Toast.makeText(LinguagemGrupo5.this,"Valor da entrada incorreta",Toast.LENGTH_SHORT).show();
    }

    private void chamaNovoQuestionario() {
        startActivity(new Intent(LinguagemGrupo5.this, LinguagemReposta.class));
        finish();
    }
