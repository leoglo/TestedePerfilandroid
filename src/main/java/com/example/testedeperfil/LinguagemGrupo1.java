...
public class LinguagemGrupo1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linguagem_grupo1);
...
// *************************************************************
    ...
    private void mensangemdeerro() {
        Toast.makeText(LinguagemGrupo1.this,"Valor da entrada incorreta",Toast.LENGTH_SHORT).show();
    }

    private void chamaNovoQuestionario() {
        startActivity(new Intent(LinguagemGrupo1.this, LinguagemGrupo2.class));
        finish();
    }
