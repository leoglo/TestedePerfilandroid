...
public class LinguagemGrupo3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_linguagem_grupo3);
...
// *************************************************************
    ...
    private void mensangemdeerro() {
        Toast.makeText(LinguagemGrupo3.this,"Valor da entrada incorreta",Toast.LENGTH_SHORT).show();
    }

    private void chamaNovoQuestionario() {
        startActivity(new Intent(LinguagemGrupo3.this, LinguagemGrupo4.class));
        finish();
    }
